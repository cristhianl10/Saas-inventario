...
class _HomeScreenState extends State<HomeScreen> {
      ...
      slivers: [
        SliverAppBar(
          ...
          flexibleSpace: FlexibleSpaceBar(
            title: const Text('Inventario', style: TextStyle(fontFamily: 'Bebas Neue', letterSpacing: 2, fontSize: 22)),
          ...
          actions: [
            CircleAvatar(
              ...
              child: const Text('SR', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 12)),
            ),
        ...
        SliverToBoxAdapter(
          child: Padding(
            ...
            child: Container(
              ...
              child: const Row(children: [SizedBox(width: 12), Icon(Icons.search, size: 16, color: Colors.grey), SizedBox(width: 8), Text('Buscar categoría...', style: TextStyle(fontSize: 12, color: Colors.grey))]),
            ),
          ),
        ),
        SliverToBoxAdapter(
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                const Text('Categorías', style: TextStyle(fontWeight: FontWeight.w900, fontSize: 12)),
                Text('${_categorias.length} categorías', style: const TextStyle(color: Colors.grey, fontSize: 11, fontWeight: FontWeight.w700)),
              ],
            ),
          ),
        ),
          ...
          SliverFillRemaining(
            child: Center(
              child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Text('Toca + para crear una', style: TextStyle(color: Colors.grey[500], fontSize: 12)),
              ]),
            ),
          )
        else
            ...
            delegate: SliverChildBuilderDelegate(
              (context, index) {
                ...
                return FutureBuilder<int>(
                  future: _apiService.getProductosPorCategoria(categoria.id!).then((p) => p.length),
                    ...
                    return Padding(
                      ...
                      child: Container(
                        ...
                        child: ListTile(
                          ...
                          leading: Container(
                            width: 36, height: 36,
                            decoration: BoxDecoration(color: _getCategoryColor(categoria.emoji), borderRadius: BorderRadius.circular(9)),
                            child: Center(child: Text(categoria.emoji, style: const TextStyle(fontSize: 18))),
                          ),
                          title: Text(categoria.nombre, style: const TextStyle(fontWeight: FontWeight.w900, fontSize: 12)),
                          subtitle: Text('$count productos', style: const TextStyle(fontSize: 10, color: Colors.grey, fontWeight: FontWeight.w700)),
                          trailing: Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              IconButton(icon: const Icon(Icons.edit, size: 16), onPressed: () => _showCategoriaDialog(categoria)),
  ...
  Widget _buildOtros() {
    return Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      Icon(_currentIndex == 1 ? Icons.inventory_2 : Icons.analytics, size: 64, color: Colors.grey[400]),
      const SizedBox(height: 16),
      Text(_currentIndex == 1 ? 'Productos' : 'Resumen', style: TextStyle(color: Colors.grey[600], fontSize: 18)),
    ]));
  }

  Widget _buildBottomNav() {
    return Container(
      decoration: const BoxDecoration(color: Colors.white, border: Border(top: BorderSide(color: Color(0xFFE5E7EB), width: 1.5))),
      child: Row(children: [
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            Text(icon, style: TextStyle(fontSize: 18, color: active ? const Color(0xFF2ABDE8) : Colors.grey[300])),
            const SizedBox(height: 2),
            Text(label, style: TextStyle(fontSize: 9, fontWeight: FontWeight.w800, color: active ? const Color(0xFF2ABDE8) : Colors.grey[400])),
          ]),
        ),
      ),
    );
